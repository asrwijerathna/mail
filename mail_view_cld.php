...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="mb-0 text-secondary">වැඩ අවසන් ලිපි <span class="badge badge-success ml-2">CLD</span></h3>
...
<div class="card shadow-sm border-0">
    ...
    <tr class="table-success">
        ...
        <td><span class="badge badge-pill badge-success px-2 py-1">CLD</span></td>
