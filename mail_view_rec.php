...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="mb-0 text-secondary">විෂය ලිපිකරු භාරගත් ලිපි <span class="badge badge-info ml-2">REC</span></h3>
...
<div class="card shadow-sm border-0">
    ...
    <tr class="table-info">
        ...
        <td><span class="badge badge-pill badge-info px-2 py-1">REC</span></td>
